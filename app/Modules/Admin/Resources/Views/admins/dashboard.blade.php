...
@section('styles')
    <!--Morris Chart-->
    <link href="{{ asset('modules/admin/plugin/morris/morris.css') }}" rel="stylesheet" type="text/css"/>
@stop
...
@section('scripts')
    <script src="{{ asset('modules/admin/js/jquery.knob.min.js') }}"></script>
    <script src="{{ asset('modules/admin/plugin/morris/morris.min.js') }}"></script>
    <script src="{{ asset('modules/admin/js/raphael.min.js') }}"></script>
    <script src="{{ asset('modules/admin/js/dashboard.init.js') }}"></script>
@stop
